...
public class NumberReservationsApiTest {
    ...
    public void createNumberReservationTest() throws ApiException {
        ...
        CompletableFuture<NumberReservationResponse> response = 
        api.createNumberReservation(createNumberReservationRequest);
    ...
    public void extendNumberReservationExpiryTimeTest() throws ApiException {
        ...
        CompletableFuture<NumberReservationResponse> response = 
        api.extendNumberReservationExpiryTime(numberReservationId);
    ...
    public void listNumberReservationsTest() throws ApiException {
        ...
        NumberReservationsApi.APIlistNumberReservationsRequest request = NumberReservationsApi.APIlistNumberReservationsRequest.newBuilder()
          ...
          .build();
        CompletableFuture<ListNumberReservationsResponse> response = 
        api.listNumberReservations(request);
    ...
    public void retrieveNumberReservationTest() throws ApiException {
        String numberReservationId = null;
        CompletableFuture<NumberReservationResponse> response = 
        api.retrieveNumberReservation(numberReservationId);

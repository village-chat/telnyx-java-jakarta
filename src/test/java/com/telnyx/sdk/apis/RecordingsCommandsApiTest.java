...
public class RecordingsCommandsApiTest {
    ...
    public void listRecordingsTest() throws ApiException {
        ...
        RecordingsCommandsApi.APIlistRecordingsRequest request = RecordingsCommandsApi.APIlistRecordingsRequest.newBuilder()
          ...
          .pageSize(pageSize)
          .build();
        CompletableFuture<ListRecordingsResponse> response = 
        api.listRecordings(request);
    ...
    public void retrieveRecordingTest() throws ApiException {
        String id = null;
        CompletableFuture<GetRecordingResponse> response = 
        api.retrieveRecording(id);

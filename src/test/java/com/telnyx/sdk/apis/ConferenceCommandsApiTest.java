...
public class ConferenceCommandsApiTest {
    ...
    public void conferenceDialParticipantInTest() throws ApiException {
        ...
        CompletableFuture<ConferenceCommandResponse> response = 
        api.conferenceDialParticipantIn(id, conferenceCallRequest);
    ...
    public void conferenceHoldParticipantsTest() throws ApiException {
        ...
        CompletableFuture<ConferenceCommandResponse> response = 
        api.conferenceHoldParticipants(id, conferenceHoldRequest);
    ...
    public void conferenceJoinTest() throws ApiException {
        ...
        CompletableFuture<ConferenceCommandResponse> response = 
        api.conferenceJoin(id, joinConferenceRequest);
    ...
    public void conferenceMuteParticipantsTest() throws ApiException {
        ...
        CompletableFuture<ConferenceCommandResponse> response = 
        api.conferenceMuteParticipants(id, conferenceMuteRequest);
    ...
    public void conferencePlayAudioTest() throws ApiException {
        ...
        CompletableFuture<ConferenceCommandResponse> response = 
        api.conferencePlayAudio(id, conferencePlayRequest);
    ...
    public void conferenceSpeakTextTest() throws ApiException {
        ...
        CompletableFuture<ConferenceCommandResponse> response = 
        api.conferenceSpeakText(id, conferenceSpeakRequest);
    ...
    public void conferenceStartRecordingTest() throws ApiException {
        ...
        CompletableFuture<ConferenceCommandResponse> response = 
        api.conferenceStartRecording(id, startRecordingRequest);
    ...
    public void conferenceStopRecordingTest() throws ApiException {
        ...
        CompletableFuture<ConferenceCommandResponse> response = 
        api.conferenceStopRecording(id, stopRecordingRequest);
    ...
    public void conferenceUnholdParticipantsTest() throws ApiException {
        ...
        CompletableFuture<ConferenceCommandResponse> response = 
        api.conferenceUnholdParticipants(id, conferenceUnholdRequest);
    ...
    public void conferenceUnmuteParticipantsTest() throws ApiException {
        ...
        CompletableFuture<ConferenceCommandResponse> response = 
        api.conferenceUnmuteParticipants(id, conferenceUnmuteRequest);
    ...
    public void createConferenceTest() throws ApiException {
        ...
        CompletableFuture<ConferenceResponse> response = 
        api.createConference(createConferenceRequest);
    ...
    public void listConferenceParticipantsTest() throws ApiException {
        ...
        CompletableFuture<ListParticipantsResponse> response = 
        api.listConferenceParticipants(conferenceId, filterMuted, filterOnHold, filterWhispering, pageNumber, pageSize);
    ...
    public void listConferencesTest() throws ApiException {
        ...
        Integer pageNumber = null;
        Integer pageSize = null;
        CompletableFuture<ListConferencesResponse> response = 
        api.listConferences(filterName, pageNumber, pageSize);

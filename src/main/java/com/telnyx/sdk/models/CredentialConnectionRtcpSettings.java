...
public class CredentialConnectionRtcpSettings {
  @SerializedName("port")
  ...
  @SerializedName("report_frequency_seconds")
  private Integer reportFrequencySeconds = 10;

  public CredentialConnectionRtcpSettings port(String port) {
    this.port = port;
    return this;
  }
  ...
  **/
  ...
  public CredentialConnectionRtcpSettings captureEnabled(Boolean captureEnabled) {
  ...
  **/
  ...
  public CredentialConnectionRtcpSettings reportFrequencySeconds(Integer reportFrequencySeconds) {
  ...
  **/
  @Schema(description = "RTCP reports are sent to customers based on the frequency set. Frequency is in seconds and it can be set to values from 5 to 3000 seconds.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CredentialConnectionRtcpSettings credentialConnectionRtcpSettings = (CredentialConnectionRtcpSettings) o;
    return Objects.equals(this.port, credentialConnectionRtcpSettings.port) &&
        Objects.equals(this.captureEnabled, credentialConnectionRtcpSettings.captureEnabled) &&
        Objects.equals(this.reportFrequencySeconds, credentialConnectionRtcpSettings.reportFrequencySeconds);
  }
  ...
  public String toString() {
    ...
    sb.append("class CredentialConnectionRtcpSettings {\n");

...
public class InboundIp {
  ...
  @SerializedName("default_primary_ip_id")
  private String defaultPrimaryIpId = null;

  @SerializedName("default_secondary_ip_id")
  private String defaultSecondaryIpId = null;

  @SerializedName("default_tertiary_ip_id")
  private String defaultTertiaryIpId = null;
  ...
  **/
  @Schema(example = "192.168.0.0", description = "The default primary IP to use for the number. Only settable if the connection is               of IP authentication type. Value must be the ID of an authorized IP set on the connection.")
  ...
  **/
  @Schema(example = "192.168.0.0", description = "The default secondary IP to use for the number. Only settable if the connection is               of IP authentication type. Value must be the ID of an authorized IP set on the connection.")
  ...
  **/
  @Schema(example = "192.168.0.0", description = "The default tertiary IP to use for the number. Only settable if the connection is               of IP authentication type. Value must be the ID of an authorized IP set on the connection.")
